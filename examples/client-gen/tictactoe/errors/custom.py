...
class GameAlreadyStarted(ProgramError):
    ...
    msg = None
CustomError = Union[TileOutOfBounds,TileAlreadySet,GameAlreadyOver,NotPlayersTurn,GameAlreadyStarted]
ANCHOR_ERROR_MAP = {6000: TileOutOfBounds, 6001: TileAlreadySet, 6002: GameAlreadyOver, 6003: NotPlayersTurn, 6004: GameAlreadyStarted}
def from_code(code: int) -> Optional[CustomError]:
