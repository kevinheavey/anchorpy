...
from tests.client_gen.example_program_gen.types.foo_enum import Named, NamedValue, Unnamed, NoFields, Struct
...
def test_null_err_when_cpi_fails() -> None:
    err_mock = RPCException({"data": {"logs": [
